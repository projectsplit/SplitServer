...
public static class ConnectionEndpoints
{
    public static void MapConnectionEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        app.MapPost("/revoke", RevokeConnectionRequestHandler);
    }
    ...
    private static async Task<IResult> RevokeConnectionRequestHandler(
        RevokeConnectionRequestRequest request,
        IMediator mediator,
        HttpContext httpContext,
        CancellationToken ct)
    {
        var command = new RevokeConnectionRequestCommand
        {
            UserId = httpContext.GetUserId(),
            ConnectionId = request.ConnectionId,
        };
